...
import { StakingNominateCall as KusamaStakingNominateCall } from '../../types/kusama/calls';
import { StakingNominateCall as PolkadotStakingNominateCall } from '../../types/polkadot/calls';
import { Store } from '@subsquid/typeorm-store';

const format = (foo: { targets: { __kind: string; value?: any }[] }) => ({
  targets: foo.targets.map((o) =>
    o.value instanceof Uint8Array ? o.value : null
  ),
});
