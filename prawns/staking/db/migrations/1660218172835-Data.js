module.exports = class Data1660218172835 {
  name = 'Data1660218172835'

  async up(db) {
    await db.query(`CREATE TABLE "substrate_staking_validator_account" ("id" character varying NOT NULL, "account" text NOT NULL, "public_key" text NOT NULL, "network" character varying(8) NOT NULL, CONSTRAINT "PK_b40747ba0a477a11a3c09289cb5" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_d8713da8add539391c637c50f9" ON "substrate_staking_validator_account" ("account") `)
    await db.query(`CREATE INDEX "IDX_62701f6d45801d910d06e1179f" ON "substrate_staking_validator_account" ("public_key") `)
    await db.query(`CREATE INDEX "IDX_8085bc5848f186694c7e2358f3" ON "substrate_staking_validator_account" ("network") `)
    await db.query(`CREATE TABLE "substrate_staking_stash_account" ("id" character varying NOT NULL, "account" text NOT NULL, "public_key" text NOT NULL, "network" character varying(8) NOT NULL, CONSTRAINT "PK_53414345f1a3d9bd7702439447e" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_0eee9d5e78d35a8d4e3f24147a" ON "substrate_staking_stash_account" ("account") `)
    await db.query(`CREATE INDEX "IDX_b6b48d3749604fbe5ebc7866e9" ON "substrate_staking_stash_account" ("public_key") `)
    ...
    await db.query(`CREATE TABLE "substrate_staking_nominator_account" ("id" character varying NOT NULL, "account" text NOT NULL, "public_key" text NOT NULL, "network" character varying(8) NOT NULL, CONSTRAINT "PK_a336f41c97a8855e054f3497e2c" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_ec84af9b1c9201728107f31fbe" ON "substrate_staking_nominator_account" ("account") `)
    await db.query(`CREATE INDEX "IDX_f70c11d573a6b079387ca1a587" ON "substrate_staking_nominator_account" ("public_key") `)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_62701f6d45801d910d06e1179f"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_b6b48d3749604fbe5ebc7866e9"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_f70c11d573a6b079387ca1a587"`)
