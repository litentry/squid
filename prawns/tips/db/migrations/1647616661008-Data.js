module.exports = class Data1647616661008 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_tip" ("id" character varying NOT NULL, "account" text NOT NULL, "root_account" text NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "who" text NOT NULL, "finder" text NOT NULL, "reason" text NOT NULL, "closes" numeric NOT NULL, "deposit" text NOT NULL, CONSTRAINT "PK_47a6dc052349ff9e667731bf1dd" PRIMARY KEY ("id"))`)
