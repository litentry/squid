...
export class TipsReportAwesomeCall {
   ...
   *  # </weight>
   */
  get asV1060(): {reason: Uint8Array, who: Uint8Array} {
    assert(this.isV1060)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
...
export class TipsTipCall {
   ...
   *  # </weight>
   */
  get asV1060(): {hash: Uint8Array, tipValue: bigint} {
    assert(this.isV1060)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
...
export class TipsTipNewCall {
   ...
   *  # </weight>
   */
  get asV1060(): {reason: Uint8Array, who: Uint8Array, tipValue: bigint} {
    assert(this.isV1060)
    return this.ctx._chain.decodeCall(this.ctx.extrinsic)
  }
