module.exports = class Data1646136602378 {
  ...
  async up(db) {
    await db.query(`CREATE TABLE "substrate_identity" ("id" character varying NOT NULL, "account" text NOT NULL, "root_account" text NOT NULL, "network" character varying(8) NOT NULL, "current" boolean NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "action" character varying(8) NOT NULL, "display" text, "email" text, "image" text, "legal" text, "pgp" text, "riot" text, "twitter" text, "web" text, CONSTRAINT "PK_fc61b34e8c000362536766596f0" PRIMARY KEY ("id"))`)
