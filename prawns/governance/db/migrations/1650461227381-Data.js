module.exports = class Data1650461227381 {
  name = 'Data1650461227381'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_treasury_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "root_account" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_index" integer NOT NULL, "beneficiary" text NOT NULL, "value" numeric NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_663a95e6e70180cc40ceb859711" PRIMARY KEY ("id"))`)
