module.exports = class Data1656854814303 {
  name = 'Data1656854814303'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_democracy_referenda" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "status" character varying(9) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "vote_threshold" text NOT NULL, "democracy_proposal_id" character varying, CONSTRAINT "PK_53c35807a0fb4f7afd2053b002e" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_8197a7fbe7e3251f0ae228099f" ON "substrate_democracy_referenda" ("democracy_proposal_id") `)
    await db.query(`CREATE TABLE "substrate_democracy_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "root_account" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_hash" text NOT NULL, "proposal_index" integer NOT NULL, "deposit_amount" numeric NOT NULL, "status" text NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "tabled_at_block" numeric, "account_id" character varying NOT NULL, "democracy_referenda_id" character varying, CONSTRAINT "PK_1ace727c2511fe1ea57ec7db260" PRIMARY KEY ("id"))`)
