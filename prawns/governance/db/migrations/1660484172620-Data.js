module.exports = class Data1660484172620 {
  name = 'Data1660484172620'

  async up(db) {
    await db.query(`CREATE TABLE "substrate_council_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "last_update" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_id" integer, "proposal_index" integer, "proposal_hash" text NOT NULL, "pallet" text, "method" text, "status" text NOT NULL, "aye_count" integer NOT NULL, "nay_count" integer NOT NULL, "threshold" integer NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_de7e32a4bd91872e2de07fc2626" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_council_vote" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_index" integer NOT NULL, "approve" boolean NOT NULL, "account_id" character varying NOT NULL, "proposal_id" character varying NOT NULL, CONSTRAINT "PK_1f1048f82fd8ea3f80453b0cd35" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_democracy_preimage" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "section" text NOT NULL, "method" text NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "balance" numeric NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_36fb062a653c63424458d14c0b6" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_7cd4050030611ed01e9e23e1ea" ON "substrate_democracy_preimage" ("account_id") `)
    await db.query(`CREATE TABLE "substrate_democracy_proposal_second" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "upper_bound" integer, "account_id" character varying NOT NULL, "proposal_id" character varying NOT NULL, CONSTRAINT "PK_819dd811b3f4d630ea6b9aab429" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_democracy_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_hash" text NOT NULL, "proposal_index" integer NOT NULL, "title" text, "description" text, "deposit_amount" numeric NOT NULL, "status" character varying(9) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "tabled_at_block" numeric, "account_id" character varying NOT NULL, "preimage_id" character varying, "democracy_referenda_id" character varying, CONSTRAINT "PK_1ace727c2511fe1ea57ec7db260" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_technical_committee_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_index" integer NOT NULL, "proposal_hash" text NOT NULL, "threshold" integer NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_a000e763ae0db4818898edc82ba" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_election_vote" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "public_key" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "candidates" text array NOT NULL, "amount" numeric NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_08102bd051fcdc0b97ec12d6877" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_phragmen_election_member_term" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "is_current_term" boolean NOT NULL, "backing" numeric NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_f273a1699e0227cea1881239e4f" PRIMARY KEY ("id"))`)
