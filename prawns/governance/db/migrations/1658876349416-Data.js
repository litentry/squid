module.exports = class Data1658876349416 {
  name = 'Data1658876349416'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_democracy_proposal" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "root_account" text NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "proposal_hash" text NOT NULL, "proposal_index" integer NOT NULL, "title" text, "description" text, "deposit_amount" numeric NOT NULL, "status" character varying(9) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "tabled_at_block" numeric, "account_id" character varying NOT NULL, "preimage_id" character varying, "democracy_referenda_id" character varying, CONSTRAINT "PK_1ace727c2511fe1ea57ec7db260" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "substrate_technical_committee_membership" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "is_current_member" boolean NOT NULL, "account_id" character varying NOT NULL, CONSTRAINT "PK_380c5210d4e9543d9df86329f8d" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_16f363a9e6c0baa524f20aaa5f" ON "substrate_technical_committee_membership" ("is_current_member") `)
    await db.query(`CREATE INDEX "IDX_0e9b053f55831f97cfe1d18498" ON "substrate_technical_committee_membership" ("account_id") `)
    ...
    await db.query(`ALTER TABLE "substrate_technical_committee_membership" ADD CONSTRAINT "FK_0e9b053f55831f97cfe1d184987" FOREIGN KEY ("account_id") REFERENCES "substrate_governance_account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_004c4739f52b87f4a44ab80f63"`)
    ...
    await db.query(`DROP TABLE "substrate_technical_committee_membership"`)
    await db.query(`DROP INDEX "public"."IDX_16f363a9e6c0baa524f20aaa5f"`)
    await db.query(`DROP INDEX "public"."IDX_0e9b053f55831f97cfe1d18498"`)
    ...
    await db.query(`ALTER TABLE "substrate_technical_committee_membership" DROP CONSTRAINT "FK_0e9b053f55831f97cfe1d184987"`)
  }
}
