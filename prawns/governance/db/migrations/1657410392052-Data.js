module.exports = class Data1657410392052 {
  name = 'Data1657410392052'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_democracy_referenda" ("id" character varying NOT NULL, "network" character varying(8) NOT NULL, "block_number" numeric NOT NULL, "date" TIMESTAMP WITH TIME ZONE NOT NULL, "title" text, "description" text, "status" character varying(9) NOT NULL, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL, "vote_threshold" text NOT NULL, "democracy_proposal_id" character varying, CONSTRAINT "PK_53c35807a0fb4f7afd2053b002e" PRIMARY KEY ("id"))`)
