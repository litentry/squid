...
export interface Call_XTransfer {
  __kind: 'XTransfer'
  value: XTransferCall
}
...
export interface Call_RmrkCore {
  __kind: 'RmrkCore'
  value: RmrkCoreCall
}

export interface Call_RmrkMarket {
  __kind: 'RmrkMarket'
  value: RmrkMarketCall
}

export interface Call_PWNftSale {
  __kind: 'PWNftSale'
  value: PWNftSaleCall
}

export interface Call_PWIncubation {
  __kind: 'PWIncubation'
  value: PWIncubationCall
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type UtilityCall = UtilityCall_batch | UtilityCall_as_derivative | UtilityCall_batch_all | UtilityCall_dispatch_as | UtilityCall_force_batch | UtilityCall_batch_try
...
/**
 * DEPRECATED: Replaced by `force_batch`
 * 
 * Send a batch of dispatch calls.
 * Unlike `batch`, it allows errors and won't interrupt.
 * 
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type ChainBridgeCall = ChainBridgeCall_set_threshold | ChainBridgeCall_whitelist_chain | ChainBridgeCall_add_relayer | ChainBridgeCall_remove_relayer | ChainBridgeCall_update_fee | ChainBridgeCall_acknowledge_proposal | ChainBridgeCall_reject_proposal | ChainBridgeCall_eval_vote_state | ChainBridgeCall_handle_fungible_transfer
 ...
 * # </weight>
 */
export interface ChainBridgeCall_update_fee {
  __kind: 'update_fee'
  fee: bigint
  destId: number
}
 ...
 */
export interface ChainBridgeCall_handle_fungible_transfer {
  __kind: 'handle_fungible_transfer'
  dest: Uint8Array
  amount: bigint
  rid: Uint8Array
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type XTransferCall = XTransferCall_transfer | XTransferCall_transfer_generic

export interface XTransferCall_transfer {
  __kind: 'transfer'
  asset: V1MultiAsset
...
export interface XTransferCall_transfer_generic {
  __kind: 'transfer_generic'
  data: Uint8Array
  dest: V1MultiLocation
  destWeight: (bigint | undefined)
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PhalaStakePoolCall = PhalaStakePoolCall_create | PhalaStakePoolCall_add_worker | PhalaStakePoolCall_remove_worker | PhalaStakePoolCall_set_cap | PhalaStakePoolCall_set_payout_pref | PhalaStakePoolCall_add_staker_to_whitelist | PhalaStakePoolCall_set_pool_description | PhalaStakePoolCall_remove_staker_from_whitelist | PhalaStakePoolCall_force_assign_reward | PhalaStakePoolCall_claim_owner_rewards | PhalaStakePoolCall_claim_staker_rewards | PhalaStakePoolCall_claim_rewards | PhalaStakePoolCall_contribute | PhalaStakePoolCall_withdraw | PhalaStakePoolCall_start_mining | PhalaStakePoolCall_stop_mining | PhalaStakePoolCall_reclaim_pool_worker | PhalaStakePoolCall_set_mining_enable | PhalaStakePoolCall_reconcile_withdraw_queue | PhalaStakePoolCall_restart_mining
 ...
 */
export interface PhalaStakePoolCall_add_staker_to_whitelist {
  __kind: 'add_staker_to_whitelist'
  pid: bigint
  staker: AccountId32
}
 ...
 * The caller must be the owner of the pool.
 */
export interface PhalaStakePoolCall_set_pool_description {
  __kind: 'set_pool_description'
  pid: bigint
  description: Uint8Array
}
 ...
 */
export interface PhalaStakePoolCall_remove_staker_from_whitelist {
  __kind: 'remove_staker_from_whitelist'
  pid: bigint
  staker: AccountId32
}
 ...
 */
export interface PhalaStakePoolCall_force_assign_reward {
  __kind: 'force_assign_reward'
  rewardArr: [bigint, bigint][]
}
 ...
 */
export interface PhalaStakePoolCall_claim_owner_rewards {
  __kind: 'claim_owner_rewards'
  pid: bigint
  target: AccountId32
}
 ...
 */
export interface PhalaStakePoolCall_claim_staker_rewards {
 ...
 */
export interface PhalaStakePoolCall_restart_mining {
  __kind: 'restart_mining'
  pid: bigint
  worker: Public
  stake: bigint
}
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsRegistryCall = AssetsRegistryCall_force_withdraw_fund | AssetsRegistryCall_force_register_asset | AssetsRegistryCall_force_unregister_asset | AssetsRegistryCall_force_set_metadata | AssetsRegistryCall_force_mint | AssetsRegistryCall_force_burn | AssetsRegistryCall_force_set_price | AssetsRegistryCall_force_set_location | AssetsRegistryCall_force_enable_chainbridge | AssetsRegistryCall_force_disable_chainbridge
 ...
 */
export interface AssetsRegistryCall_force_withdraw_fund {
  __kind: 'force_withdraw_fund'
  assetId: (number | undefined)
  recipient: AccountId32
  amount: bigint
}

export interface AssetsRegistryCall_force_register_asset {
 ...
 */
export interface AssetsRegistryCall_force_unregister_asset {
  __kind: 'force_unregister_asset'
  assetId: number
}

export interface AssetsRegistryCall_force_set_metadata {
  __kind: 'force_set_metadata'
  assetId: number
  properties: AssetProperties
}

export interface AssetsRegistryCall_force_mint {
  __kind: 'force_mint'
  assetId: number
...
export interface AssetsRegistryCall_force_burn {
  __kind: 'force_burn'
  assetId: number
  who: AccountId32
  amount: bigint
...
export interface AssetsRegistryCall_force_set_price {
  __kind: 'force_set_price'
  assetId: number
  executionPrice: bigint
}

export interface AssetsRegistryCall_force_set_location {
  __kind: 'force_set_location'
  assetId: number
  location: V1MultiLocation
}

export interface AssetsRegistryCall_force_enable_chainbridge {
...
export interface AssetsRegistryCall_force_disable_chainbridge {
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RmrkCoreCall = RmrkCoreCall_mint_nft | RmrkCoreCall_create_collection | RmrkCoreCall_burn_nft | RmrkCoreCall_destroy_collection | RmrkCoreCall_send | RmrkCoreCall_accept_nft | RmrkCoreCall_reject_nft | RmrkCoreCall_change_collection_issuer | RmrkCoreCall_set_property | RmrkCoreCall_lock_collection | RmrkCoreCall_add_basic_resource | RmrkCoreCall_add_composable_resource | RmrkCoreCall_add_slot_resource | RmrkCoreCall_accept_resource | RmrkCoreCall_remove_resource | RmrkCoreCall_accept_resource_removal | RmrkCoreCall_set_priority
 ...
 */
export interface RmrkCoreCall_mint_nft {
  __kind: 'mint_nft'
  ...
  resources: (ResourceTypes[] | undefined)
}

/**
 * Create a collection
 */
export interface RmrkCoreCall_create_collection {
 ...
 * burn nft
 */
export interface RmrkCoreCall_burn_nft {
  __kind: 'burn_nft'
  collectionId: number
  nftId: number
}
 ...
 * destroy collection
 */
export interface RmrkCoreCall_destroy_collection {
 ...
 */
export interface RmrkCoreCall_send {
  __kind: 'send'
  collectionId: number
  nftId: number
  newOwner: AccountIdOrCollectionNftTuple
}
 ...
 *   sent to
 */
export interface RmrkCoreCall_accept_nft {
  __kind: 'accept_nft'
  collectionId: number
  nftId: number
  newOwner: AccountIdOrCollectionNftTuple
 ...
 * - `nft_id`: nft id of the nft to be accepted
 */
export interface RmrkCoreCall_reject_nft {
  __kind: 'reject_nft'
  collectionId: number
  nftId: number
}
 ...
 */
export interface RmrkCoreCall_change_collection_issuer {
  __kind: 'change_collection_issuer'
  collectionId: number
 ...
 */
export interface RmrkCoreCall_set_property {
  __kind: 'set_property'
  collectionId: number
 ...
 * lock collection
 */
export interface RmrkCoreCall_lock_collection {
 ...
 */
export interface RmrkCoreCall_add_basic_resource {
  __kind: 'add_basic_resource'
  collectionId: number
  nftId: number
 ...
 */
export interface RmrkCoreCall_add_composable_resource {
  __kind: 'add_composable_resource'
  collectionId: number
  nftId: number
 ...
 */
export interface RmrkCoreCall_add_slot_resource {
  __kind: 'add_slot_resource'
  collectionId: number
  nftId: number
 ...
 */
export interface RmrkCoreCall_accept_resource {
  __kind: 'accept_resource'
  collectionId: number
  nftId: number
  resourceId: number
}
 ...
 * remove resource
 */
export interface RmrkCoreCall_remove_resource {
 ...
 */
export interface RmrkCoreCall_accept_resource_removal {
  __kind: 'accept_resource_removal'
  collectionId: number
  nftId: number
  resourceId: number
}
 ...
 */
export interface RmrkCoreCall_set_priority {
  __kind: 'set_priority'
  collectionId: number
  nftId: number
  priorities: number[]
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type RmrkMarketCall = RmrkMarketCall_buy | RmrkMarketCall_list | RmrkMarketCall_unlist | RmrkMarketCall_make_offer | RmrkMarketCall_withdraw_offer | RmrkMarketCall_accept_offer
 ...
 */
export interface RmrkMarketCall_buy {
  __kind: 'buy'
  collectionId: number
  nftId: number
 ...
 */
export interface RmrkMarketCall_list {
  __kind: 'list'
  collectionId: number
  nftId: number
  amount: bigint
 ...
 * - `nft_id` - NFT id of the RMRK NFT
 */
export interface RmrkMarketCall_unlist {
  __kind: 'unlist'
  collectionId: number
  nftId: number
}
 ...
 */
export interface RmrkMarketCall_make_offer {
  __kind: 'make_offer'
  collectionId: number
  nftId: number
  amount: bigint
 ...
 * - `nft_id` - NFT id of the RMRK NFT
 */
export interface RmrkMarketCall_withdraw_offer {
  __kind: 'withdraw_offer'
  collectionId: number
  nftId: number
}

export interface RmrkMarketCall_accept_offer {
  __kind: 'accept_offer'
  collectionId: number
  nftId: number
  offerer: AccountId32
 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PWNftSaleCall = PWNftSaleCall_claim_spirit | PWNftSaleCall_redeem_spirit | PWNftSaleCall_buy_rare_origin_of_shell | PWNftSaleCall_buy_prime_origin_of_shell | PWNftSaleCall_preorder_origin_of_shell | PWNftSaleCall_mint_chosen_preorders | PWNftSaleCall_refund_not_chosen_preorders | PWNftSaleCall_mint_gift_origin_of_shell | PWNftSaleCall_set_overlord | PWNftSaleCall_initialize_world_clock | PWNftSaleCall_set_status_type | PWNftSaleCall_init_rarity_type_counts | PWNftSaleCall_update_rarity_type_counts | PWNftSaleCall_set_spirit_collection_id | PWNftSaleCall_set_origin_of_shell_collection_id | PWNftSaleCall_pw_create_collection | PWNftSaleCall_set_spirits_metadata | PWNftSaleCall_set_origin_of_shells_metadata
 ...
 */
export interface PWNftSaleCall_claim_spirit {
  __kind: 'claim_spirit'
}
 ...
 * - origin: The origin of the extrinsic.
 */
export interface PWNftSaleCall_redeem_spirit {
  __kind: 'redeem_spirit'
 ...
 *   on metadata
 */
export interface PWNftSaleCall_buy_rare_origin_of_shell {
  __kind: 'buy_rare_origin_of_shell'
 ...
 */
export interface PWNftSaleCall_buy_prime_origin_of_shell {
  __kind: 'buy_prime_origin_of_shell'
  signature: Uint8Array
  race: RaceType
  career: CareerType
}
 ...
 */
export interface PWNftSaleCall_preorder_origin_of_shell {
  __kind: 'preorder_origin_of_shell'
  race: RaceType
  career: CareerType
}
 ...
 */
export interface PWNftSaleCall_mint_chosen_preorders {
  __kind: 'mint_chosen_preorders'
  preorders: number[]
}
 ...
 */
export interface PWNftSaleCall_refund_not_chosen_preorders {
  __kind: 'refund_not_chosen_preorders'
  preorders: number[]
}
 ...
 */
export interface PWNftSaleCall_mint_gift_origin_of_shell {
  __kind: 'mint_gift_origin_of_shell'
  owner: AccountId32
  rarityType: RarityType
  race: RaceType
  career: CareerType
  nftSaleType: NftSaleType
}
 ...
 */
export interface PWNftSaleCall_set_overlord {
  __kind: 'set_overlord'
 ...
 */
export interface PWNftSaleCall_initialize_world_clock {
  __kind: 'initialize_world_clock'
}
 ...
 */
export interface PWNftSaleCall_set_status_type {
  __kind: 'set_status_type'
  status: boolean
 ...
 */
export interface PWNftSaleCall_init_rarity_type_counts {
  __kind: 'init_rarity_type_counts'
}
 ...
 */
export interface PWNftSaleCall_update_rarity_type_counts {
  __kind: 'update_rarity_type_counts'
  rarityType: RarityType
  forSaleCount: number
 ...
 */
export interface PWNftSaleCall_set_spirit_collection_id {
  __kind: 'set_spirit_collection_id'
  collectionId: number
}
 ...
 */
export interface PWNftSaleCall_set_origin_of_shell_collection_id {
  __kind: 'set_origin_of_shell_collection_id'
  collectionId: number
}
 ...
 */
export interface PWNftSaleCall_pw_create_collection {
  __kind: 'pw_create_collection'
  metadata: Uint8Array
  max: (number | undefined)
  symbol: Uint8Array
}
 ...
 */
export interface PWNftSaleCall_set_spirits_metadata {
  __kind: 'set_spirits_metadata'
  spiritsMetadata: Uint8Array
}
 ...
 */
export interface PWNftSaleCall_set_origin_of_shells_metadata {
  __kind: 'set_origin_of_shells_metadata'
  originOfShellsMetadata: [RaceType, Uint8Array][]
}

/**
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type PWIncubationCall = PWIncubationCall_start_incubation | PWIncubationCall_feed_origin_of_shell | PWIncubationCall_hatch_origin_of_shell | PWIncubationCall_update_incubation_time | PWIncubationCall_set_can_start_incubation_status | PWIncubationCall_set_shell_collection_id
 ...
 */
export interface PWIncubationCall_start_incubation {
  __kind: 'start_incubation'
  collectionId: number
  nftId: number
}
 ...
 * - nft_id: The NFT id of the Origin of Shell RMRK NFT
 */
export interface PWIncubationCall_feed_origin_of_shell {
  __kind: 'feed_origin_of_shell'
  collectionId: number
  nftId: number
}
 ...
 */
export interface PWIncubationCall_hatch_origin_of_shell {
  __kind: 'hatch_origin_of_shell'
  collectionId: number
  nftId: number
  metadata: Uint8Array
}
 ...
 *   hatch times by
 */
export interface PWIncubationCall_update_incubation_time {
  __kind: 'update_incubation_time'
  originOfShells: [[number, number], bigint][]
}
 ...
 */
export interface PWIncubationCall_set_can_start_incubation_status {
  __kind: 'set_can_start_incubation_status'
  status: boolean
}
 ...
 */
export interface PWIncubationCall_set_shell_collection_id {
  __kind: 'set_shell_collection_id'
  collectionId: number
}
...
export type VersionedXcm_197 = VersionedXcm_197_V0 | VersionedXcm_197_V1 | VersionedXcm_197_V2

export interface VersionedXcm_197_V0 {
  __kind: 'V0'
  value: V0Xcm_198
}

export interface VersionedXcm_197_V1 {
  __kind: 'V1'
  value: V1Xcm_203
}

export interface VersionedXcm_197_V2 {
  __kind: 'V2'
  value: V2Instruction_63[]
}
...
export type VersionedXcm_208 = VersionedXcm_208_V0 | VersionedXcm_208_V1 | VersionedXcm_208_V2

export interface VersionedXcm_208_V0 {
  __kind: 'V0'
  value: V0Xcm_209
}

export interface VersionedXcm_208_V1 {
  __kind: 'V1'
  value: V1Xcm_214
}

export interface VersionedXcm_208_V2 {
  __kind: 'V2'
  value: V2Instruction_220[]
}
...
export interface DestroyWitness_302 {
  accounts: number
  sufficients: number
  approvals: number
}
...
export interface DestroyWitness_306 {
  items: number
  itemMetadatas: number
  attributes: number
}

export type ResourceTypes = ResourceTypes_Basic | ResourceTypes_Composable | ResourceTypes_Slot

export interface ResourceTypes_Basic {
  __kind: 'Basic'
  value: BasicResource
}

export interface ResourceTypes_Composable {
  __kind: 'Composable'
  value: ComposableResource
}

export interface ResourceTypes_Slot {
  __kind: 'Slot'
  value: SlotResource
}
...
export interface BasicResource {
  ...
  license: (Uint8Array | undefined)
  thumb: (Uint8Array | undefined)
}

export interface ComposableResource {
  parts: number[]
  base: number
  src: (Uint8Array | undefined)
  metadata: (Uint8Array | undefined)
...
export type NftSaleType = NftSaleType_ForSale | NftSaleType_Giveaway | NftSaleType_Reserved

export interface NftSaleType_ForSale {
  __kind: 'ForSale'
}

export interface NftSaleType_Giveaway {
  __kind: 'Giveaway'
}

export interface NftSaleType_Reserved {
  __kind: 'Reserved'
}

export type StatusType = StatusType_ClaimSpirits | StatusType_PurchaseRareOriginOfShells | StatusType_PurchasePrimeOriginOfShells | StatusType_PreorderOriginOfShells | StatusType_LastDayOfSale

export interface StatusType_ClaimSpirits {
  __kind: 'ClaimSpirits'
}

export interface StatusType_PurchaseRareOriginOfShells {
  __kind: 'PurchaseRareOriginOfShells'
}

export interface StatusType_PurchasePrimeOriginOfShells {
  __kind: 'PurchasePrimeOriginOfShells'
}

export interface StatusType_PreorderOriginOfShells {
  __kind: 'PreorderOriginOfShells'
}

export interface StatusType_LastDayOfSale {
  __kind: 'LastDayOfSale'
}

export type RawOrigin_329 = RawOrigin_329_Root | RawOrigin_329_Signed | RawOrigin_329_None

export interface RawOrigin_329_Root {
  __kind: 'Root'
}

export interface RawOrigin_329_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_329_None {
  __kind: 'None'
}

export type Origin_330 = Origin_330_Relay | Origin_330_SiblingParachain

export interface Origin_330_Relay {
  __kind: 'Relay'
}

export interface Origin_330_SiblingParachain {
  __kind: 'SiblingParachain'
  value: Id
}

export type Origin_331 = Origin_331_Xcm | Origin_331_Response

export interface Origin_331_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_331_Response {
  __kind: 'Response'
  value: V1MultiLocation
}

export type RawOrigin_332 = RawOrigin_332_Members | RawOrigin_332_Member | RawOrigin_332__Phantom

export interface RawOrigin_332_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_332_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_332__Phantom {
  __kind: '_Phantom'
}
...
export type V0Xcm_198 = V0Xcm_198_WithdrawAsset | V0Xcm_198_ReserveAssetDeposit | V0Xcm_198_TeleportAsset | V0Xcm_198_QueryResponse | V0Xcm_198_TransferAsset | V0Xcm_198_TransferReserveAsset | V0Xcm_198_Transact | V0Xcm_198_HrmpNewChannelOpenRequest | V0Xcm_198_HrmpChannelAccepted | V0Xcm_198_HrmpChannelClosing | V0Xcm_198_RelayedFrom

export interface V0Xcm_198_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_200[]
}

export interface V0Xcm_198_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_200[]
}

export interface V0Xcm_198_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_200[]
}

export interface V0Xcm_198_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_198_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_198_TransferReserveAsset {
...
export interface V0Xcm_198_Transact {
  __kind: 'Transact'
...
export interface V0Xcm_198_HrmpNewChannelOpenRequest {
...
export interface V0Xcm_198_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_198_HrmpChannelClosing {
...
export interface V0Xcm_198_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_198
}

export type V1Xcm_203 = V1Xcm_203_WithdrawAsset | V1Xcm_203_ReserveAssetDeposited | V1Xcm_203_ReceiveTeleportedAsset | V1Xcm_203_QueryResponse | V1Xcm_203_TransferAsset | V1Xcm_203_TransferReserveAsset | V1Xcm_203_Transact | V1Xcm_203_HrmpNewChannelOpenRequest | V1Xcm_203_HrmpChannelAccepted | V1Xcm_203_HrmpChannelClosing | V1Xcm_203_RelayedFrom | V1Xcm_203_SubscribeVersion | V1Xcm_203_UnsubscribeVersion

export interface V1Xcm_203_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_205[]
}

export interface V1Xcm_203_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_205[]
}

export interface V1Xcm_203_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_205[]
}

export interface V1Xcm_203_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_203_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_203_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  effects: V1Order_205[]
...
export interface V1Xcm_203_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_203_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_203_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_203_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_203_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_203
}

export interface V1Xcm_203_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_203_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_63 = V2Instruction_63_WithdrawAsset | V2Instruction_63_ReserveAssetDeposited | V2Instruction_63_ReceiveTeleportedAsset | V2Instruction_63_QueryResponse | V2Instruction_63_TransferAsset | V2Instruction_63_TransferReserveAsset | V2Instruction_63_Transact | V2Instruction_63_HrmpNewChannelOpenRequest | V2Instruction_63_HrmpChannelAccepted | V2Instruction_63_HrmpChannelClosing | V2Instruction_63_ClearOrigin | V2Instruction_63_DescendOrigin | V2Instruction_63_ReportError | V2Instruction_63_DepositAsset | V2Instruction_63_DepositReserveAsset | V2Instruction_63_ExchangeAsset | V2Instruction_63_InitiateReserveWithdraw | V2Instruction_63_InitiateTeleport | V2Instruction_63_QueryHolding | V2Instruction_63_BuyExecution | V2Instruction_63_RefundSurplus | V2Instruction_63_SetErrorHandler | V2Instruction_63_SetAppendix | V2Instruction_63_ClearError | V2Instruction_63_ClaimAsset | V2Instruction_63_Trap | V2Instruction_63_SubscribeVersion | V2Instruction_63_UnsubscribeVersion

export interface V2Instruction_63_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_63_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_63_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_63_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_63_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_63_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_63[]
}

export interface V2Instruction_63_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_63_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_63_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_63_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_63_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_63_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_63_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_63_DepositAsset {
  __kind: 'DepositAsset'
...
export interface V2Instruction_63_DepositReserveAsset {
...
export interface V2Instruction_63_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_63_InitiateReserveWithdraw {
...
export interface V2Instruction_63_InitiateTeleport {
...
export interface V2Instruction_63_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_63_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_63_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_63_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_63[]
}

export interface V2Instruction_63_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_63[]
}

export interface V2Instruction_63_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_63_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_63_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_63_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_63_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export type V0Xcm_209 = V0Xcm_209_WithdrawAsset | V0Xcm_209_ReserveAssetDeposit | V0Xcm_209_TeleportAsset | V0Xcm_209_QueryResponse | V0Xcm_209_TransferAsset | V0Xcm_209_TransferReserveAsset | V0Xcm_209_Transact | V0Xcm_209_HrmpNewChannelOpenRequest | V0Xcm_209_HrmpChannelAccepted | V0Xcm_209_HrmpChannelClosing | V0Xcm_209_RelayedFrom

export interface V0Xcm_209_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_211[]
}

export interface V0Xcm_209_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_211[]
}

export interface V0Xcm_209_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_211[]
}

export interface V0Xcm_209_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_209_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_209_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_200[]
...
export interface V0Xcm_209_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V0Xcm_209_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V0Xcm_209_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_209_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V0Xcm_209_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_209
}

export type V1Xcm_214 = V1Xcm_214_WithdrawAsset | V1Xcm_214_ReserveAssetDeposited | V1Xcm_214_ReceiveTeleportedAsset | V1Xcm_214_QueryResponse | V1Xcm_214_TransferAsset | V1Xcm_214_TransferReserveAsset | V1Xcm_214_Transact | V1Xcm_214_HrmpNewChannelOpenRequest | V1Xcm_214_HrmpChannelAccepted | V1Xcm_214_HrmpChannelClosing | V1Xcm_214_RelayedFrom | V1Xcm_214_SubscribeVersion | V1Xcm_214_UnsubscribeVersion

export interface V1Xcm_214_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_216[]
}

export interface V1Xcm_214_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_216[]
}

export interface V1Xcm_214_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_216[]
}

export interface V1Xcm_214_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_214_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_214_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  effects: V1Order_205[]
...
export interface V1Xcm_214_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_214_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_214_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_214_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_214_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_214
}

export interface V1Xcm_214_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_214_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_220 = V2Instruction_220_WithdrawAsset | V2Instruction_220_ReserveAssetDeposited | V2Instruction_220_ReceiveTeleportedAsset | V2Instruction_220_QueryResponse | V2Instruction_220_TransferAsset | V2Instruction_220_TransferReserveAsset | V2Instruction_220_Transact | V2Instruction_220_HrmpNewChannelOpenRequest | V2Instruction_220_HrmpChannelAccepted | V2Instruction_220_HrmpChannelClosing | V2Instruction_220_ClearOrigin | V2Instruction_220_DescendOrigin | V2Instruction_220_ReportError | V2Instruction_220_DepositAsset | V2Instruction_220_DepositReserveAsset | V2Instruction_220_ExchangeAsset | V2Instruction_220_InitiateReserveWithdraw | V2Instruction_220_InitiateTeleport | V2Instruction_220_QueryHolding | V2Instruction_220_BuyExecution | V2Instruction_220_RefundSurplus | V2Instruction_220_SetErrorHandler | V2Instruction_220_SetAppendix | V2Instruction_220_ClearError | V2Instruction_220_ClaimAsset | V2Instruction_220_Trap | V2Instruction_220_SubscribeVersion | V2Instruction_220_UnsubscribeVersion

export interface V2Instruction_220_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_220_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_220_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_220_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_220_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_220_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_63[]
...
export interface V2Instruction_220_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_220_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_220_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_220_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_220_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_220_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_220_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_220_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_220_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_220_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_220_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_63[]
...
export interface V2Instruction_220_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_63[]
...
export interface V2Instruction_220_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_220_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_220_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_220_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_220[]
}

export interface V2Instruction_220_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_220[]
}

export interface V2Instruction_220_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_220_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_220_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_220_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_220_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export type V0Order_200 = V0Order_200_Null | V0Order_200_DepositAsset | V0Order_200_DepositReserveAsset | V0Order_200_ExchangeAsset | V0Order_200_InitiateReserveWithdraw | V0Order_200_InitiateTeleport | V0Order_200_QueryHolding | V0Order_200_BuyExecution

export interface V0Order_200_Null {
  __kind: 'Null'
}

export interface V0Order_200_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_200_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_200[]
...
export interface V0Order_200_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_200_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
...
export interface V0Order_200_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_200[]
...
export interface V0Order_200_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_200_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_205 = V1Order_205_Noop | V1Order_205_DepositAsset | V1Order_205_DepositReserveAsset | V1Order_205_ExchangeAsset | V1Order_205_InitiateReserveWithdraw | V1Order_205_InitiateTeleport | V1Order_205_QueryHolding | V1Order_205_BuyExecution

export interface V1Order_205_Noop {
  __kind: 'Noop'
}

export interface V1Order_205_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_205_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_205_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_205_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_205[]
...
export interface V1Order_205_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_205[]
...
export interface V1Order_205_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_205_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_203[]
}
...
export type V0Order_211 = V0Order_211_Null | V0Order_211_DepositAsset | V0Order_211_DepositReserveAsset | V0Order_211_ExchangeAsset | V0Order_211_InitiateReserveWithdraw | V0Order_211_InitiateTeleport | V0Order_211_QueryHolding | V0Order_211_BuyExecution

export interface V0Order_211_Null {
  __kind: 'Null'
}

export interface V0Order_211_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_211_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_200[]
...
export interface V0Order_211_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_211_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
  reserve: V0MultiLocation
  effects: V0Order_200[]
...
export interface V0Order_211_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_200[]
...
export interface V0Order_211_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_211_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_216 = V1Order_216_Noop | V1Order_216_DepositAsset | V1Order_216_DepositReserveAsset | V1Order_216_ExchangeAsset | V1Order_216_InitiateReserveWithdraw | V1Order_216_InitiateTeleport | V1Order_216_QueryHolding | V1Order_216_BuyExecution

export interface V1Order_216_Noop {
  __kind: 'Noop'
}

export interface V1Order_216_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_216_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_216_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_216_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_205[]
...
export interface V1Order_216_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_205[]
...
export interface V1Order_216_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_216_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_214[]
}
...
export type MessageOrigin = MessageOrigin_Pallet | MessageOrigin_Contract | MessageOrigin_Worker | MessageOrigin_AccountId | MessageOrigin_MultiLocation | MessageOrigin_Gatekeeper | MessageOrigin_Cluster
...
export interface MessageOrigin_Cluster {
  __kind: 'Cluster'
  value: H256
}
