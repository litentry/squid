 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsRegistryCall = AssetsRegistryCall_force_withdraw_fund | AssetsRegistryCall_force_register_asset | AssetsRegistryCall_force_unregister_asset | AssetsRegistryCall_force_set_metadata | AssetsRegistryCall_force_set_price | AssetsRegistryCall_force_enable_chainbridge | AssetsRegistryCall_force_disable_chainbridge
...
export interface RmrkCoreCall_mint_nft {
  ...
  owner: AccountId32
  collectionId: number
  recipient: (AccountId32 | undefined)
...
export type RawOrigin_326 = RawOrigin_326_Root | RawOrigin_326_Signed | RawOrigin_326_None

export interface RawOrigin_326_Root {
  __kind: 'Root'
}

export interface RawOrigin_326_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_326_None {
  __kind: 'None'
}

export type Origin_327 = Origin_327_Relay | Origin_327_SiblingParachain

export interface Origin_327_Relay {
  __kind: 'Relay'
}

export interface Origin_327_SiblingParachain {
  __kind: 'SiblingParachain'
  value: Id
}

export type Origin_328 = Origin_328_Xcm | Origin_328_Response

export interface Origin_328_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_328_Response {
  __kind: 'Response'
  value: V1MultiLocation
}

export type RawOrigin_329 = RawOrigin_329_Members | RawOrigin_329_Member | RawOrigin_329__Phantom

export interface RawOrigin_329_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_329_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_329__Phantom {
  __kind: '_Phantom'
}
