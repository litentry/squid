...
export interface Type_165_PhalaOneshotTransfer {
  __kind: 'PhalaOneshotTransfer'
  value: PhalaOneshotTransferCall
}
...
export type BridgeTransferCall = BridgeTransferCall_change_fee | BridgeTransferCall_transfer_native | BridgeTransferCall_transfer
...
export type PhalaMiningCall = PhalaMiningCall_set_cool_down_expiration | PhalaMiningCall_unbind | PhalaMiningCall_reclaim | PhalaMiningCall_force_heartbeat | PhalaMiningCall_force_start_mining | PhalaMiningCall_force_stop_mining | PhalaMiningCall_update_tokenomic
 ...
 */
export interface PhalaMiningCall_reclaim {
  __kind: 'reclaim'
  miner: Uint8Array
}
 ...
 */
export interface PhalaStakePoolCall_relcaim_pool_worker {
  __kind: 'relcaim_pool_worker'
  pid: bigint
  worker: Uint8Array
}
...
export type PhalaOneshotTransferCall = PhalaOneshotTransferCall_distribute

/**
 *  Distributes some amounts to each specified accounts and mark the sender and destination
 *  accounts as blacklisted.
 */
export interface PhalaOneshotTransferCall_distribute {
  __kind: 'distribute'
  transfers: [Uint8Array, bigint][]
}
...
export interface Type_20_PhalaOneshotTransfer {
  __kind: 'PhalaOneshotTransfer'
  value: PhalaOneshotTransferCall
}
