...
export type VersionedXcm_189 = VersionedXcm_189_V0 | VersionedXcm_189_V1 | VersionedXcm_189_V2

export interface VersionedXcm_189_V0 {
  __kind: 'V0'
  value: V0Xcm_190
}

export interface VersionedXcm_189_V1 {
  __kind: 'V1'
  value: V1Xcm_195
}

export interface VersionedXcm_189_V2 {
  __kind: 'V2'
  value: V2Instruction_201[]
}
...
export type RawOrigin_287 = RawOrigin_287_Root | RawOrigin_287_Signed | RawOrigin_287_None

export interface RawOrigin_287_Root {
  __kind: 'Root'
}

export interface RawOrigin_287_Signed {
  __kind: 'Signed'
  value: AccountId32
}

export interface RawOrigin_287_None {
  __kind: 'None'
}

export type Origin_288 = Origin_288_Relay | Origin_288_SiblingParachain

export interface Origin_288_Relay {
  __kind: 'Relay'
}

export interface Origin_288_SiblingParachain {
  __kind: 'SiblingParachain'
  value: Id
}

export type Origin_289 = Origin_289_Xcm | Origin_289_Response

export interface Origin_289_Xcm {
  __kind: 'Xcm'
  value: V1MultiLocation
}

export interface Origin_289_Response {
  __kind: 'Response'
  value: V1MultiLocation
}

export type RawOrigin_290 = RawOrigin_290_Members | RawOrigin_290_Member | RawOrigin_290__Phantom

export interface RawOrigin_290_Members {
  __kind: 'Members'
  value: [number, number]
}

export interface RawOrigin_290_Member {
  __kind: 'Member'
  value: AccountId32
}

export interface RawOrigin_290__Phantom {
  __kind: '_Phantom'
}
...
export type V0Xcm_190 = V0Xcm_190_WithdrawAsset | V0Xcm_190_ReserveAssetDeposit | V0Xcm_190_TeleportAsset | V0Xcm_190_QueryResponse | V0Xcm_190_TransferAsset | V0Xcm_190_TransferReserveAsset | V0Xcm_190_Transact | V0Xcm_190_HrmpNewChannelOpenRequest | V0Xcm_190_HrmpChannelAccepted | V0Xcm_190_HrmpChannelClosing | V0Xcm_190_RelayedFrom

export interface V0Xcm_190_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V0MultiAsset[]
  effects: V0Order_192[]
}

export interface V0Xcm_190_ReserveAssetDeposit {
  __kind: 'ReserveAssetDeposit'
  assets: V0MultiAsset[]
  effects: V0Order_192[]
}

export interface V0Xcm_190_TeleportAsset {
  __kind: 'TeleportAsset'
  assets: V0MultiAsset[]
  effects: V0Order_192[]
}

export interface V0Xcm_190_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V0Response
}

export interface V0Xcm_190_TransferAsset {
  __kind: 'TransferAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Xcm_190_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_181[]
...
export interface V0Xcm_190_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V0Xcm_190_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V0Xcm_190_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V0Xcm_190_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V0Xcm_190_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V0MultiLocation
  message: V0Xcm_190
}

export type V1Xcm_195 = V1Xcm_195_WithdrawAsset | V1Xcm_195_ReserveAssetDeposited | V1Xcm_195_ReceiveTeleportedAsset | V1Xcm_195_QueryResponse | V1Xcm_195_TransferAsset | V1Xcm_195_TransferReserveAsset | V1Xcm_195_Transact | V1Xcm_195_HrmpNewChannelOpenRequest | V1Xcm_195_HrmpChannelAccepted | V1Xcm_195_HrmpChannelClosing | V1Xcm_195_RelayedFrom | V1Xcm_195_SubscribeVersion | V1Xcm_195_UnsubscribeVersion

export interface V1Xcm_195_WithdrawAsset {
  __kind: 'WithdrawAsset'
  assets: V1MultiAssets
  effects: V1Order_197[]
}

export interface V1Xcm_195_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  assets: V1MultiAssets
  effects: V1Order_197[]
}

export interface V1Xcm_195_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  assets: V1MultiAssets
  effects: V1Order_197[]
}

export interface V1Xcm_195_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V1Response
}

export interface V1Xcm_195_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V1Xcm_195_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  effects: V1Order_186[]
...
export interface V1Xcm_195_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V1Xcm_195_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V1Xcm_195_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V1Xcm_195_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V1Xcm_195_RelayedFrom {
  __kind: 'RelayedFrom'
  who: V1Junctions
  message: V1Xcm_195
}

export interface V1Xcm_195_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V1Xcm_195_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}

export type V2Instruction_201 = V2Instruction_201_WithdrawAsset | V2Instruction_201_ReserveAssetDeposited | V2Instruction_201_ReceiveTeleportedAsset | V2Instruction_201_QueryResponse | V2Instruction_201_TransferAsset | V2Instruction_201_TransferReserveAsset | V2Instruction_201_Transact | V2Instruction_201_HrmpNewChannelOpenRequest | V2Instruction_201_HrmpChannelAccepted | V2Instruction_201_HrmpChannelClosing | V2Instruction_201_ClearOrigin | V2Instruction_201_DescendOrigin | V2Instruction_201_ReportError | V2Instruction_201_DepositAsset | V2Instruction_201_DepositReserveAsset | V2Instruction_201_ExchangeAsset | V2Instruction_201_InitiateReserveWithdraw | V2Instruction_201_InitiateTeleport | V2Instruction_201_QueryHolding | V2Instruction_201_BuyExecution | V2Instruction_201_RefundSurplus | V2Instruction_201_SetErrorHandler | V2Instruction_201_SetAppendix | V2Instruction_201_ClearError | V2Instruction_201_ClaimAsset | V2Instruction_201_Trap | V2Instruction_201_SubscribeVersion | V2Instruction_201_UnsubscribeVersion

export interface V2Instruction_201_WithdrawAsset {
  __kind: 'WithdrawAsset'
  value: V1MultiAssets
}

export interface V2Instruction_201_ReserveAssetDeposited {
  __kind: 'ReserveAssetDeposited'
  value: V1MultiAssets
}

export interface V2Instruction_201_ReceiveTeleportedAsset {
  __kind: 'ReceiveTeleportedAsset'
  value: V1MultiAssets
}

export interface V2Instruction_201_QueryResponse {
  __kind: 'QueryResponse'
  queryId: bigint
  response: V2Response
  maxWeight: bigint
...
export interface V2Instruction_201_TransferAsset {
  __kind: 'TransferAsset'
  assets: V1MultiAssets
  beneficiary: V1MultiLocation
}

export interface V2Instruction_201_TransferReserveAsset {
  __kind: 'TransferReserveAsset'
  assets: V1MultiAssets
  dest: V1MultiLocation
  xcm: V2Instruction_63[]
...
export interface V2Instruction_201_Transact {
  __kind: 'Transact'
  originType: V0OriginKind
  requireWeightAtMost: bigint
  call: DoubleEncoded
...
export interface V2Instruction_201_HrmpNewChannelOpenRequest {
  __kind: 'HrmpNewChannelOpenRequest'
  sender: number
  maxMessageSize: number
  maxCapacity: number
...
export interface V2Instruction_201_HrmpChannelAccepted {
  __kind: 'HrmpChannelAccepted'
  recipient: number
}

export interface V2Instruction_201_HrmpChannelClosing {
  __kind: 'HrmpChannelClosing'
  initiator: number
  sender: number
  recipient: number
...
export interface V2Instruction_201_ClearOrigin {
  __kind: 'ClearOrigin'
}

export interface V2Instruction_201_DescendOrigin {
  __kind: 'DescendOrigin'
  value: V1Junctions
}

export interface V2Instruction_201_ReportError {
  __kind: 'ReportError'
  queryId: bigint
  dest: V1MultiLocation
  maxResponseWeight: bigint
...
export interface V2Instruction_201_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V2Instruction_201_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V2Instruction_201_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V2Instruction_201_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  xcm: V2Instruction_63[]
...
export interface V2Instruction_201_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  xcm: V2Instruction_63[]
...
export interface V2Instruction_201_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V2Instruction_201_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weightLimit: V2WeightLimit
}

export interface V2Instruction_201_RefundSurplus {
  __kind: 'RefundSurplus'
}

export interface V2Instruction_201_SetErrorHandler {
  __kind: 'SetErrorHandler'
  value: V2Instruction_201[]
}

export interface V2Instruction_201_SetAppendix {
  __kind: 'SetAppendix'
  value: V2Instruction_201[]
}

export interface V2Instruction_201_ClearError {
  __kind: 'ClearError'
}

export interface V2Instruction_201_ClaimAsset {
  __kind: 'ClaimAsset'
  assets: V1MultiAssets
  ticket: V1MultiLocation
}

export interface V2Instruction_201_Trap {
  __kind: 'Trap'
  value: bigint
}

export interface V2Instruction_201_SubscribeVersion {
  __kind: 'SubscribeVersion'
  queryId: bigint
  maxResponseWeight: bigint
}

export interface V2Instruction_201_UnsubscribeVersion {
  __kind: 'UnsubscribeVersion'
}
...
export type V0Order_192 = V0Order_192_Null | V0Order_192_DepositAsset | V0Order_192_DepositReserveAsset | V0Order_192_ExchangeAsset | V0Order_192_InitiateReserveWithdraw | V0Order_192_InitiateTeleport | V0Order_192_QueryHolding | V0Order_192_BuyExecution

export interface V0Order_192_Null {
  __kind: 'Null'
}

export interface V0Order_192_DepositAsset {
  __kind: 'DepositAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
}

export interface V0Order_192_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_181[]
...
export interface V0Order_192_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V0MultiAsset[]
  receive: V0MultiAsset[]
}

export interface V0Order_192_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V0MultiAsset[]
  reserve: V0MultiLocation
  effects: V0Order_181[]
...
export interface V0Order_192_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V0MultiAsset[]
  dest: V0MultiLocation
  effects: V0Order_181[]
...
export interface V0Order_192_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V0MultiLocation
  assets: V0MultiAsset[]
...
export interface V0Order_192_BuyExecution {
  __kind: 'BuyExecution'
  fees: V0MultiAsset
  weight: bigint
  debt: bigint
...
export type V1Order_197 = V1Order_197_Noop | V1Order_197_DepositAsset | V1Order_197_DepositReserveAsset | V1Order_197_ExchangeAsset | V1Order_197_InitiateReserveWithdraw | V1Order_197_InitiateTeleport | V1Order_197_QueryHolding | V1Order_197_BuyExecution

export interface V1Order_197_Noop {
  __kind: 'Noop'
}

export interface V1Order_197_DepositAsset {
  __kind: 'DepositAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  beneficiary: V1MultiLocation
...
export interface V1Order_197_DepositReserveAsset {
  __kind: 'DepositReserveAsset'
  assets: V1MultiAssetFilter
  maxAssets: number
  dest: V1MultiLocation
...
export interface V1Order_197_ExchangeAsset {
  __kind: 'ExchangeAsset'
  give: V1MultiAssetFilter
  receive: V1MultiAssets
}

export interface V1Order_197_InitiateReserveWithdraw {
  __kind: 'InitiateReserveWithdraw'
  assets: V1MultiAssetFilter
  reserve: V1MultiLocation
  effects: V1Order_186[]
...
export interface V1Order_197_InitiateTeleport {
  __kind: 'InitiateTeleport'
  assets: V1MultiAssetFilter
  dest: V1MultiLocation
  effects: V1Order_186[]
...
export interface V1Order_197_QueryHolding {
  __kind: 'QueryHolding'
  queryId: bigint
  dest: V1MultiLocation
  assets: V1MultiAssetFilter
...
export interface V1Order_197_BuyExecution {
  __kind: 'BuyExecution'
  fees: V1MultiAsset
  weight: bigint
  debt: bigint
  haltOnError: boolean
  instructions: V1Xcm_195[]
}
