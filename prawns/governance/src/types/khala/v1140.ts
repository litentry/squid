 ...
 * Contains one variant per dispatchable that can be called by an extrinsic.
 */
export type AssetsRegistryCall = AssetsRegistryCall_force_withdraw_fund | AssetsRegistryCall_force_register_asset | AssetsRegistryCall_force_unregister_asset | AssetsRegistryCall_force_set_metadata | AssetsRegistryCall_force_enable_chainbridge | AssetsRegistryCall_force_disable_chainbridge
