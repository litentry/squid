...
export interface Type_177_Offences {
  __kind: 'Offences'
  value: OffencesCall
}
...
export interface Type_177_AuthorityDiscovery {
  __kind: 'AuthorityDiscovery'
  value: AuthorityDiscoveryCall
}
