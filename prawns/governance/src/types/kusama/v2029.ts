...
export interface Type_185_ElectionProviderMultiPhase {
...
export interface Type_186_ElectionProviderMultiPhase {
  __kind: 'ElectionProviderMultiPhase'
  value: ElectionProviderMultiPhaseCall
}
