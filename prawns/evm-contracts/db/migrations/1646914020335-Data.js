module.exports = class Data1646914020335 {
  name = 'Data1646914020335'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_evm_contract" ("id" character varying NOT NULL, "type" text NOT NULL, "creator" text NOT NULL, "evm_tx_hash" text NOT NULL, "network" character varying(8) NOT NULL, CONSTRAINT "PK_9c9387cadded49d8892be463ea4" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_9074699245795b4b08e7757f33" ON "substrate_evm_contract" ("type") `)
    await db.query(`CREATE INDEX "IDX_d889686b21501d6c269420ac00" ON "substrate_evm_contract" ("creator") `)
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_d889686b21501d6c269420ac00"`)
