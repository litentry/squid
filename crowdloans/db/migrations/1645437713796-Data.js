module.exports = class Data1645437713796 {
  name = 'Data1645437713796'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "substrate_chronicle" ("id" character varying NOT NULL, "cur_block_number" integer, "cur_lease" integer, "cur_lease_start" integer, "cur_lease_end" integer, "cur_auction_id" character varying, CONSTRAINT "PK_4bea5354d3b9d2422b680491bee" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_4b3fd3596f4baf5e289a83bf53" ON "substrate_chronicle" ("cur_auction_id") `)
    await db.query(`CREATE TABLE "substrate_parachain" ("id" character varying NOT NULL, "para_id" integer NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE, "creation_block" integer, "deregistered" boolean NOT NULL, "deposit" numeric NOT NULL, "manager" text NOT NULL, "chronicle_id" character varying, CONSTRAINT "PK_affcbca43be5a76a312df92d626" PRIMARY KEY ("id"))`)
    ...
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" DROP COLUMN "date"`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" ADD "parachain_id" character varying NOT NULL`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" ADD "fund_id" character varying NOT NULL`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" DROP COLUMN "block_number"`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" ADD "block_number" integer NOT NULL`)
    ...
    await db.query(`ALTER TABLE "substrate_chronicle" ADD CONSTRAINT "FK_4b3fd3596f4baf5e289a83bf534" FOREIGN KEY ("cur_auction_id") REFERENCES "substrate_auction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "substrate_parachain" ADD CONSTRAINT "FK_f429235f40d5b655b62db773a54" FOREIGN KEY ("chronicle_id") REFERENCES "substrate_chronicle"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  async down(db) {
    ...
    await db.query(`DROP TABLE "substrate_chronicle"`)
    await db.query(`DROP INDEX "public"."IDX_4b3fd3596f4baf5e289a83bf53"`)
    ...
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" ADD "date" TIMESTAMP WITH TIME ZONE NOT NULL`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" DROP COLUMN "created_at"`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" DROP COLUMN "parachain_id"`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" DROP COLUMN "fund_id"`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" ADD "block_number" numeric NOT NULL`)
    await db.query(`ALTER TABLE "substrate_crowdloan_contribution" DROP COLUMN "block_number"`)
    ...
    await db.query(`ALTER TABLE "substrate_chronicle" DROP CONSTRAINT "FK_4b3fd3596f4baf5e289a83bf534"`)
